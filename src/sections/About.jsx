  ...
  return (
	<section id= 'about' className='px-auto mt-44'>
	  <div className='flex flex-col md:flex-row gap-14 md:gap-18 max-w-7xl mx-auto '>
		...
		<Animated>
			<h2 className='mt-5 text-4xl md:text-5xl text-balance'>Experience dining beyond expectations</h2>
		</Animated>
		...
		<Animated className="mt-9 bg-orange-500 text-white p-2 pr-8 rounded-lg flex items-center gap-3 w-fit">
			<img src="/assets/about.png" alt="Bistro Royals Location Preview" className='size-15 rounded-lg object-cover shrink-0'/>
			<div>
