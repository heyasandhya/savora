		...
		<section id='booking-process' className='px-auto mt-44'>
			<div className='max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-25'>
				...
				<div className='flex flex-col text-center md:text-left'>
					...
					<Animated delay={0.2}>
						<p className='text-zinc-600 max-w-xs max-md:mx-auto mb-4'>"{bookingTestimonial.quote}"</p>
					</Animated>

					<Animated className="flex items-cener justify-center md:justify-start gap-3">
				...
				<div className='space-y-14 text-left'>
					{bookingSteps.map((step, index) => (
						<Animated key={index} y={150} delay={index*0.15} className="items-start gap-9">
